...
### 🧪 The Scriptorium (Math Playground)
...
## 🎨 Design Philosophy: Tactile Bento
...
- **Interactions**: Vanilla JavaScript & [View Transitions API](https://developer.mozilla.org/en-US/docs/Web/API/View_Transitions_API)
- **Mathematical Rendering**: [KaTeX](https://katex.org/)
- **Content Parsing**: [Marked](https://marked.js.org/)
...
---
<p align="center">
  <i>Developed with precision by <a href="https://github.com/apoo711">Aryan Gupta</a></i>
</p>
